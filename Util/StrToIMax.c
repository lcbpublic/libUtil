...
/******************************************************************************
 * Equivalent to strtoimax() but with simplified error reporting.
 ...
 *****************************************************************************/
int StrToIMax(const char *Str, int Base, intmax_t *Val)
{ /* StrToIMax(const char *, int, intmax_t *) */
  char *End = NULL;
  intmax_t NewVal;
