...
/******************************************************************************
 * Equivalent to strtoi64() but with simplified error reporting.
 ...
 *****************************************************************************/
int StrToInt64(const char *Str, int Base, int64_t *Val)
{ /* StrToInt64(const char *, int, int64_t *) */
  char *End = NULL;
  int64_t NewVal;
